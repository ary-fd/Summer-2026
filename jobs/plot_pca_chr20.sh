...
python3 /u/scratch/h/haroldzw/Student_project/PCA/plot_pca.py \
  --eigenvec /u/scratch/a/aryadini/PCA/PCA_out/pca_out_chr20.eigenvec \
  --eigenval /u/scratch/a/aryadini/PCA/PCA_out/pca_out_chr20.eigenval \
  ...
  --out /u/scratch/a/aryadini/PCA/PCA_plots/pca_chr20.png