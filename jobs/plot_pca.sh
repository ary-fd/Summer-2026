...
python3 /u/scratch/h/haroldzw/Student_project/PCA/plot_pca.py \
  --eigenvec /u/scratch/a/aryadini/PCA/PCA_out/pca_out.eigenvec \
  --eigenval /u/scratch/a/aryadini/PCA/PCA_out/pca_out.eigenval \
  ...
  --out /u/scratch/a/aryadini/PCA/PCA_plots/pca.png